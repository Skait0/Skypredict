...
async function buildPayload(options = {}) {
  ...
  for (const f of fixtures) {
    ...
    out.push({
      ...
      /* If team-resolved, don't assert a specific league — use a generic
         label so EFL/Carabao/FA Cup ties don't show as "England Premier League". */
      league: wasTeamResolved ? "Cup (domestic)" : idx.leagues[li],
      home: h, away: a,
