...
const UNRATED_COMPETITION =
  /\b(simulated|srl|esoccer|e-?football|virtual)\b|\b(amateur|amateure|junior(?:en|s)?|youth|jugend|academy|primavera|reserves?|jong|u ?1[5-9]|u ?2[0-3])\b|\bwomen(?:'s|s)?\b|\bfrauen\b|\bfemenin[ao]\b|\bf[ée]minin(?:e|es)?\b/i;
...
const UNRATED_LEAGUE_PREFIX = ["Russia 2. Liga"];
