...
<div class="prose cv">
  ...
  <div class="books">
    ...
    ${book("1X2 or Over / Under", "2.5 only", "1.5 and 3.5 only")}
  </div>
  ...
  <div class="move">
    ...
    <p>SportyBet sells it only at 2.5, Bet9ja only at 1.5 and 3.5. Moving one is
    a whole goal, not a half, so it is
