...
/* NO GLOW BAND HERE, deliberately. The app has one because its bar sits at
   the top of a landing page with nothing behind it, so the glass had nothing
   to reveal. These are documents: content starts immediately and scrolls under
   the bar within a screen, which is the glass doing its job on its own.
   A full-bleed glow was tried and removed - it needs viewport units to reach
   past the 680px column, and 100vw counts the scrollbar, which put 348px of
   horizontal scroll on every one of 1,120 pages. Not worth a tint. */
