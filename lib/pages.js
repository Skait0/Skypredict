...
<div class="prose cv">
  ...
  Paste one here and get the same games back as a code for the other one.</p>
  ...
  <ol class="steps">
    <li><b>1</b><span>We read the slip behind your code and show you the games.</span></li>
    <li><b>2</b><span>Anything that cannot move is named, game by game, with the reason.</span></li>
    <li><b>3</b><span>Press the button in the panel and you get the other
      book's code. The split into separate tickets is offered beside it.</span></li>
  </ol>

  <h2>The rules, if you want them</h2>
  ...
  ${fold("The lines that have to change to travel", `
    ...
    <p><b>Whole Over/Under lines.</b> SportyBet sells Over 2 and Over 3; Bet9ja
    stops at the half lines. Over 2 returns your stake on exactly two goals
    where Over 1.5 has already won, so these are not the same bet. The leg moves
    to the nearest line Bet9ja sells and every screen that shows it says it was
    changed.</p>
    <div class="swap"><span>1 or Over 1.5</span><i>becomes</i><span class="to">1 or Over 2.5</span></div>
    <p><b>1X2 or Over/Under.</b> Both books sell this at 2.5, so those legs cross
    untouched. Bet9ja also sells 1.5 and 3.5 and SportyBet sells neither. Moving
    one of those is a whole goal, not a half, so it is
