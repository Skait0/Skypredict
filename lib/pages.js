...
const TOPNAV = [
  ["/", "Predictions", false],
  ["/booking-codes", "Free codes", false],
...
function pushControl() {
  ...
  return '<div class="ck-ask" id="pushAsk" hidden></div>' +
    ...
    "if(ios&&!standalone){" +
    'host.innerHTML="<p class=\'ck-asknote\'>To get this alert on iPhone, tap Share ' +
    'and Add to Home Screen. Safari only allows notifications for installed apps.</p>";' +
