...
/* Decode first: the board carries some names entity-encoded already
   ("Bosnia &amp; Herzegovina"), and escaping those again prints "&amp;". */
...
function reply(book, code, legs, fixtures, site) {
  ...
  const out = ["🔮 <b>Wizard's Eye</b> · " + esc(B) + " <code>" + esc(code) + "</code>",
